...
class SobremesaAdapter (
    ...
    inner class DessertViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val itemTotal: Text = itemView.findViewById(R.id.textViewItemTotal_2)
        ...
        val button: Button = itemView.findViewById(R.id.buttonAddToCart_2)
    }
    ...
    override fun onBindViewHolder(holder: SobremesaAdapter.DessertViewHolder, position: Int) {
